...
os.environ.setdefault("SUPPRESS_VARIABLE_NOT_ASSIGNED_ERROR", "1")
...
def run_migrations_offline() -> None:
    ...
    context.configure(
        ...
        render_as_batch=True,  # 🔑 이거 추가
        compare_type=True,  # 컬럼 타입 비교
        compare_server_default=True,  # default 값 비교
    )
